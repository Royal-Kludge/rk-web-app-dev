...
//0xD400 128*4=512 byte
code const U32 Fn2_KeyMatrix[2][128]={
{   
	//C00-------------------------------------------------------------------------------------------------------------0
	0x00,		KEY_ESC,				0x00,					0x00,							0x00,									SP_KB_Mode,     	 
	//C01-------------------------------------------------------------------------------------------------------------1
	0x00,		KEY_F1,					0x00,					SP_Windows_Mode,	0x00,									0x00,	
	//C02-------------------------------------------------------------------------------------------------------------2
...
{   
	...
	0x00,		KEY_ESC,				0x00,					0x00,							0x00,									SP_KB_Mode,     	 
	//C01-------------------------------------------------------------------------------------------------------------1
	0x00,		KEY_SysBkBrigthDec,	0x00,			SP_Windows_Mode,	0x00,									0x00,	
	//C02-------------------------------------------------------------------------------------------------------------2
	0x00,		KEY_SysBkBrigthInc,	0x00,			SP_Mac_Mode,			0x00,									0x00, 				 	 			
	//C03-------------------------------------------------------------------------------------------------------------3
	0x00,		KEY_UP_CTRL,		0x00,					0x00,							0x00,									0x00,    					   
	//C04-------------------------------------------------------------------------------------------------------------4
	0x00,		KEY_D_WIN,			0x00,					0x00,							0x00,									0x00,							  						 						
	//C05-------------------------------------------------------------------------------------------------------------5	
	0x00,		KEY_LED_LUMIND,	0x00,					SP_TEST_EMI,			0x00,									SP_ProfileReset,		 			 			    
	//C06-------------------------------------------------------------------------------------------------------------6
	0x00,		KEY_LED_LUMINI,	0x00,					0x00,							0x00,									0x00,		
	//C07-------------------------------------------------------------------------------------------------------------7
