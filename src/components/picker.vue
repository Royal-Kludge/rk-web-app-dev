<template>
    <div class="d-flex flex-column">
      <div class="d-flex ai-center">
        <el-tag :color="`rgb(${cursorPosition.rgb.r}, ${cursorPosition.rgb.g}, ${cursorPosition.rgb.b})`" style="border-width: 0px; border-radius: 20%;"/>
        <el-input v-model="cursorPosition.rgb.color" style="width: 68px; margin-left: 10px;" size="small" @change="colorHexChanged()" :maxlength="7"/>
        <span style="margin-left: 10px">R</span>
        <el-input-number v-model="cursorPosition.rgb.r" :min="0" :max="255" size="small" :controls="false" @change="colorChanged()"/>
        <span style="margin-left: 10px">G</span>
        <el-input-number v-model="cursorPosition.rgb.g" :min="0" :max="255" size="small" :controls="false" @change="colorChanged()"/>
        <span style="margin-left: 10px">B</span>
        <el-input-number v-model="cursorPosition.rgb.b" :min="0" :max="255" size="small" :controls="false" @change="colorChanged()"/>
      </div>
