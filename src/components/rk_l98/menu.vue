...
onMounted(() => {
  ...
  rk_l98.value.addEventListener(RK_L98_EVENT_DEFINE.OnPasswordGotten, passwordGotten, false);
...
onBeforeUnmount(() => {
    if (rk_l98.value != undefined) {
        ...
        rk_l98.value.removeEventListener(RK_L98_EVENT_DEFINE.OnPasswordGotten, passwordGotten, false);
    }
});
