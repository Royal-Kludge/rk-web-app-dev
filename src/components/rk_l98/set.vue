...
import { useLightStore } from "@/stores/rk_l98/lightStore";
import { useSetStore } from "@/stores/setStore";
import { useKeyStore } from "@/stores/rk_l98/keyStore";
import { useMacroStore } from "@/stores/rk_l98/macroStore";
...
const getVer = () => {
    ...
    if (pid == 0x01FB) {
        axios.get('/down/work/RKWEB/firmware/L98/L98_firmware_us.json').then(response => {
            // 请求成功处理
        ...
        axios.get('/down/work/RKWEB/firmware/L98/L98_firmware_uk.json').then(response => {
            // 请求成功处理
            version.value = response.data.version
            url.value = response.data.url
            checkVer()
