<template>
    <div class="d-flex jc-between text-grey">
        <div class="dot"></div>
        <div class="d-flex flex-column ai-center dot">
            <div><img src="../../assets/images/menu/high/down.png" /></div>
            <div>1.0mm</div>
        </div>
        <div class="d-flex flex-column ai-center dot">
            <div><img src="../../assets/images/menu/high/down.png" /></div>
        ...
        <div class="d-flex flex-column ai-center dot">
            <div><img src="../../assets/images/menu/high/up.png" /></div>
            <div>3.6mm</div>
        </div>
        <div class="d-flex flex-column ai-center dot">
            <div><img src="../../assets/images/menu/high/up.png" /></div>
