...
onMounted(() => {
  ...
  rk_m70.value.addEventListener(RK_M70_EVENT_DEFINE.OnPasswordGotten, passwordGotten, false);
...
onBeforeUnmount(() => {
    if (rk_m70.value != undefined) {
        ...
        rk_m70.value.removeEventListener(RK_M70_EVENT_DEFINE.OnPasswordGotten, passwordGotten, false);
    }
});
