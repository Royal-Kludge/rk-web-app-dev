import { Packet_Dongle_Block_Set } from "@/keyboard/rk_r98pro/packets/dongle/setPacket";
import { REPORT_PAYLOAD_LENGTH, MACRO_PER_BLOCK_LENGTH } from "@/keyboard/rk_r98pro/packets/packet";
