import { Packet_Dongle_Set } from "@/keyboard/rk_n99/packets/dongle/setPacket";
import { KeyMatrixLayer, MatrixTable } from "@/keyboard/enum"
import type { IPacket } from "@/keyboard/interface";
import { Packet_Dongle, REPORT_PAYLOAD_LENGTH, MACRO_PER_BLOCK_LENGTH, REPORT_MAX_RETRY } from "@/keyboard/rk_n99/packets/packet";
