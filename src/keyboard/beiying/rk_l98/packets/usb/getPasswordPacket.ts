...
import { Packet_Usb, PROFILE_LENGTH, PACKET_HEAD_LENGTH } from "@/keyboard/beiying/rk_l98/packets/packet";
...
export class GetPasswordPacket extends Packet_Usb {
    ...
    fromReportData(buffer: DataView) : IPacket {
        ...
        if (this.getReport.byteLength >= 10 + PACKET_HEAD_LENGTH) {
            this.fwVersion = `${this.getReport.getUint8(13).toString(16).padStart(2, '0')}${this.getReport.getUint8(14).toString(16).padStart(2, '0')}`
        }
        return this;
    }
}