...
import { RK_F99_Dongle } from './rk_f99_dongle'
import { RK_F99_Usb } from './rk_f99_usb'
import { ConnectionType, DeviceType, ProtocolType } from '@/device/enum'

export const RK_F99_USB_DEFINE: KeyboardDefine = {
    name: "RK-F99",
    image: "keyboard_rk-f99.png",
    vendorId: 0x258A,
    productId: 0x0218,
    usagePage: 0xFF00,
    usage: 0x0001,
    ...
    protocol: RK_F99_Usb.create
}

export const RK_F99_DONGLE_DEFINE: KeyboardDefine = {
    name: "RK-F99",
    image: "keyboard_rk-f99.png",
    vendorId: 0x3554,
    productId: 0xFA09,
