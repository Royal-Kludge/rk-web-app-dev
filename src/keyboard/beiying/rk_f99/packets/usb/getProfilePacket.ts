...
import { Packet_Usb, PROFILE_LENGTH, PACKET_HEAD_LENGTH } from "@/keyboard/beiying/rk_f99/packets/packet";
import { BoardProfile } from "@/keyboard/beiying/rk_f99/boardProfile";
