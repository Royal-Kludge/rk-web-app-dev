...
import { RK_F99, RK_F99_EVENT_DEFINE } from './rk_f99';
...
export class RK_F99_Usb extends RK_F99 {
    ...
    static async create(state: KeyboardState, device: HIDDevice) {
        return new RK_F99_Usb(state, device);
    }
    ...
    async getPassword(): Promise<void> {
        ...
        //this.dispatchEvent(new CustomEvent(RK_M70_EVENT_DEFINE.OnProfileGotten, { detail: this.data.profile }));
    }
