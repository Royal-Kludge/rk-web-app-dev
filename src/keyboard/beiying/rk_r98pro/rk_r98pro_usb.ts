...
import { RK_R98, RK_R98_EVENT_DEFINE } from './rk_r98pro';
...
export class RK_R98_Usb extends RK_R98 {
    ...
    static async create(state: KeyboardState, device: HIDDevice) {
        return new RK_R98_Usb(state, device);
    }
    ...
    async getPassword(): Promise<void> {
        ...
        //this.dispatchEvent(new CustomEvent(RK_L98_EVENT_DEFINE.OnProfileGotten, { detail: this.data.profile }));
    }
