...
import { RK_N99, RK_N99_EVENT_DEFINE } from './rk_n99';
...
export class RK_N99_Usb extends RK_N99 {
    ...
    static async create(state: KeyboardState, device: HIDDevice) {
        return new RK_N99_Usb(state, device);
    }
    ...
    async getPassword(): Promise<void> {
        ...
        //this.dispatchEvent(new CustomEvent(RK_N99_EVENT_DEFINE.OnProfileGotten, { detail: this.data.profile }));
    }
