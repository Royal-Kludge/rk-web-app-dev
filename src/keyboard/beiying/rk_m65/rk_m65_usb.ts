...
import { RK_M65, RK_M65_EVENT_DEFINE } from './rk_m65';
...
export class RK_M65_Usb extends RK_M65 {
    ...
    static async create(state: KeyboardState, device: HIDDevice) {
        return new RK_M65_Usb(state, device);
    }
    ...
    async getPassword(): Promise<void> {
        ...
        //this.dispatchEvent(new CustomEvent(RK_M65_EVENT_DEFINE.OnProfileGotten, { detail: this.data.profile }));
    }
