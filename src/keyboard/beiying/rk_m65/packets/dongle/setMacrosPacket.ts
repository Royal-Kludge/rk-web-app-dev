import { Packet_Dongle_Block_Set } from "@/keyboard/beiying/rk_m65/packets/dongle/setPacket";
import { REPORT_PAYLOAD_LENGTH, MACRO_PER_BLOCK_LENGTH } from "@/keyboard/beiying/rk_m65/packets/packet";
