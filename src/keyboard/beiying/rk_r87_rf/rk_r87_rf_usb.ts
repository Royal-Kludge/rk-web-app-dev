...
import { RK_R87_RF, RK_R87_RF_EVENT_DEFINE } from './rk_r87_rf';
...
export class RK_R87_RF_Usb extends RK_R87_RF {
    ...
    static async create(state: KeyboardState, device: HIDDevice) {
        return new RK_R87_RF_Usb(state, device);
    }
    ...
    async getPassword(): Promise<void> {
        ...
        //this.dispatchEvent(new CustomEvent(RK_R87_RF_EVENT_DEFINE.OnProfileGotten, { detail: this.data.profile }));
    }
