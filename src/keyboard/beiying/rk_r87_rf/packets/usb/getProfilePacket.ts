...
import { Packet_Usb, PROFILE_LENGTH, PACKET_HEAD_LENGTH } from "@/keyboard/beiying/rk_r87_rf/packets/packet";
import { BoardProfile } from "@/keyboard/beiying/rk_r87_rf/boardProfile";
