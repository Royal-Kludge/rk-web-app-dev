...
export class RK_L75_Usb extends RK_L75 {
    ...
    static async create(state: KeyboardState, device: HIDDevice) {
        return new RK_L75_Usb(state, device);
    }
    ...
    async getPassword(): Promise<void> {
        ...
        //this.dispatchEvent(new CustomEvent(RK_L75_EVENT_DEFINE.OnProfileGotten, { detail: this.data.profile }));
    }
