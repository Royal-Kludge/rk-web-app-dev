...
export const KeyMap_FN1_RF_Win: Array<KeyDefineEnum> = [
	...
	KeyDefineEnum.KEY_VolumI,         KeyDefineEnum.NONE,			        KeyDefineEnum.NONE,          KeyDefineEnum.NONE,                KeyDefineEnum.NONE,          	   KeyDefineEnum.NONE,		    
	//-------------------------------------------------------------------------------------------------------------13        
	KeyDefineEnum.KEY_Calculator,     KeyDefineEnum.NONE,                   KeyDefineEnum.NONE,          KeyDefineEnum.SP_BATT_IND_ENTER,   KeyDefineEnum.NONE,          	   KeyDefineEnum.KEY_Fn_Ctrl,
	//-------------------------------------------------------------------------------------------------------------14        
	KeyDefineEnum.SP_LED_REC,         KeyDefineEnum.KEY_LED_COLOR_SIDEL,    KeyDefineEnum.NONE,          KeyDefineEnum.NONE,                KeyDefineEnum.NONE,          	   KeyDefineEnum.KEY_LED_BREATHD,     	         
	//-------------------------------------------------------------------------------------------------------------15      
