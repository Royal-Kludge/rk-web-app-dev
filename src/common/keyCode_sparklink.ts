...
export const KeyText: Record<number, Array<String>> = {
    ...
    0x7301: ['sparklink.keyText.mouseKey.leftKey'],
    0x7302: ['sparklink.keyText.mouseKey.rightKey'],
    0x7303: ['sparklink.keyText.mouseKey.middleKey'],
    0x7304: ['sparklink.keyText.mouseKey.xAxleLeft'],
    0x7305: ['sparklink.keyText.mouseKey.xAxleRight'],
    0x7306: ['sparklink.keyText.mouseKey.yAxleDown'],
    0x7307: ['sparklink.keyText.mouseKey.yAxleUp'],
    0x7308: ['sparklink.keyText.mouseKey.wheel_forward'],
    0x7309: ['sparklink.keyText.mouseKey.wheel_reverse'],
    ...
    0x106F: ['sparklink.keyText.functionKey.brightnessI'],
    0x1070: ['sparklink.keyText.functionKey.brightnessD'],
    ...
    0xF100: ['sparklink.keyText.controlKey.restore'],
    0xF101: ['sparklink.keyText.controlKey.win'],
    0xF102: ['sparklink.keyText.controlKey.mac'],
    0xF103: ['sparklink.keyText.controlKey.calibration'],
    0xF108: ['sparklink.keyText.controlKey.profile1'],
    0xF109: ['sparklink.keyText.controlKey.profile2'],
    0xF10A: ['sparklink.keyText.controlKey.profile3'],
    0xF10B: ['sparklink.keyText.controlKey.switchWASD'],
    ...
    0xF314: ['sparklink.keyText.controlKey.speedI'],
    0xF315: ['sparklink.keyText.controlKey.speedD'],
    0xF317: ['sparklink.keyText.controlKey.ledOnOff'],

    0xF325: ['sparklink.keyText.controlKey.ambientLedModeI'],
    0xF326: ['sparklink.keyText.controlKey.ambientledOnOff'],
    0xF327: ['sparklink.keyText.controlKey.ambientLedDirection'],
    0xF328: ['sparklink.keyText.controlKey.ambientLedSpeedI'],
    0xF329: ['sparklink.keyText.controlKey.ambientLedSpeedD'],
    0xF32A: ['sparklink.keyText.controlKey.ambientLedBrightnessI'],
    0xF32B: ['sparklink.keyText.controlKey.ambientLedBrightnessD'],
    0xF32C: ['sparklink.keyText.controlKey.ambientLedModeDec'],

    0xF32F: ['sparklink.keyText.controlKey.ledModeD'],
    0xF336: ['sparklink.keyText.controlKey.ledStaticChange'],
    0xF339: ['Snap Tap On '],
}
