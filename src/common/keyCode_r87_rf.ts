...
export enum KeyDefineEnum {
    ...
    //logo
    KEY_LOG_MODEL = 0x08000101, //ֱ���趨Ϊģʽ+
    KEY_LOG_MODEI = 0x08000201, //ֱ���趨Ϊģʽ-
    KEY_LOG_MODED = 0x08000001, //ֱ���趨ΪģʽLOOP

    //side
    KEY_SIDE_MODEL = 0x08000102, //ֱ���趨Ϊģʽ+
    KEY_SIDE_MODEI = 0x08000202, //ֱ���趨Ϊģʽ-
    KEY_SIDE_MODED = 0x08000002, //ֱ���趨ΪģʽLOOP
...
export const KeyText: Record<number, String> = {
    ...
    0x07000030: 'BATT_IND_ENTER',
    0x07000031: 'BATT_IND_EXIT',
    0x08ff0000: 'KB_REC_Reset', 
    //****************************************************************
    //byte0���̶�0x08
    //byte1��0��Ч�л���1��Ч����2��ɫ�л���3�����л���4�ٶ��л���5������Ϸ����¼�ƣ�6��Ϸ���ֱ��棬7¼��/���棬8��λ��9��Чģʽָ��
    //byte2��0ѭ����1+/��2-/�ң����byte1Ϊ9����������ֵ������ǰģʽ
    ...
    //logo
    0x08000101: 'LogoModelLoop',
    0x08000201: 'LogoModel+',
    0x08000001: 'LogoModel-',

    //logo
    0x08000102: 'SideModelLoop',
    0x08000202: 'SideModel+',
    0x08000002: 'SideModel-',
