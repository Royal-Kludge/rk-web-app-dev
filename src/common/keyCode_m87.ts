...
export enum KeyDefineEnum {
    ...
    SP_Home_key = 0x0700000d,
    SP_Mute_Mode = 0x0700000e,      //����Windows
    SP_L_Mode = 0x0700000f,		//
    SP_Mac_Mode = 0x07000021,      //����Mac   
    SP_Windeos_Mode = 0x07000020,      //����Windows   
    SP_KB_Mode = 0x07000010,
    SP_O_Mode = 0x07000012,      //����Mac
    SP_Save_Time = 0x07000022,      //����Mac
...
export const KeyText: Record<number, Array<String>> = {
    ...
    0x07000013: ['LED_OFF'],
    0x07000015: ['KB_Mode'],
    0x07000020: ['Win'],      //����Windows  
    0x07000021: ['Mac'],
    0x07000022: ['Save_Time'],      //����Mac
    0x07000023: ['Unknow'],      
