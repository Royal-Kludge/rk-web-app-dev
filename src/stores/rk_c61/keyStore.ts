...
import { type KeyMappingData, type KeyTableData, type KeyState, type KeyLine } from '@/keyboard/sparklink/interface'
...
export const useKeyStore = defineStore('keyinfo_rk_c61', () => {
  ...
  const keyMatrix_us = [
    ...
    },
    {
      ...
      keys: [       
        ...
        { key: KeyDefineEnum.CTRL_R, style: 'key key6', index: getIndex(5, 12), keyData: getKeyData(getIndex(5, 12)) },
      ]
    },
  ];
  ...
  return { profile, state, keyMatrixLayer, keyMatrixTable, init, destroy, setFunid, isFunSelected, setUnselected, unSelected, mapping, saveProfile, getKeyMatrix }
})