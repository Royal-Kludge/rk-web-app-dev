...
import { BoardProfile, FieldEnum } from '@/keyboard/beiying/rk_f99/boardProfile';
...
import { ps } from '@/keyboard/beiying/rk_f99/profiles';

export const uselightStore = defineStore('lightinfo_rk_f99', () => {
    ...
    const state = reactive({
        ...
        keyMatrix: [
            ...
            { key: KeyDefineEnum.KEY_DEL, index: getIndex(0, 13), },
            { key: KeyDefineEnum.KEY_PRINT, index: getIndex(0, 15), },
            { key: KeyDefineEnum.KEY_PGUP, index: getIndex(0, 16), },
            { key: KeyDefineEnum.KEY_PGDN, index: getIndex(0, 17), },
            { key: KeyDefineEnum.KEY_END, index: getIndex(0, 18), },
            ...
            { key: KeyDefineEnum.KEY_NUMLOCK, index: getIndex(1, 15), },
            { key: KeyDefineEnum.KEY_NUM_DIV, index: getIndex(1, 16), },
            { key: KeyDefineEnum.KEY_NUM_MUL, index: getIndex(1, 17), },
            { key: KeyDefineEnum.KEY_NUM_MINUS, index: getIndex(1, 18), },
            ...
            { key: KeyDefineEnum.KEY_Slash, index: getIndex(2, 13), },
            { key: KeyDefineEnum.KEY_NUM_7, index: getIndex(2, 15), },
            { key: KeyDefineEnum.KEY_NUM_8, index: getIndex(2, 16), },
            { key: KeyDefineEnum.KEY_NUM_9, index: getIndex(2, 17), },
            { key: KeyDefineEnum.KEY_NUM_PLUS, index: getIndex(2, 18), },
            ...
            { key: KeyDefineEnum.KEY_CODE42, index: getIndex(3, 12), },
            { key: KeyDefineEnum.KEY_ENTER, index: getIndex(3, 13), },
            { key: KeyDefineEnum.KEY_NUM_4, index: getIndex(3, 15), },
            { key: KeyDefineEnum.KEY_NUM_5, index: getIndex(3, 16), },
            { key: KeyDefineEnum.KEY_NUM_6, index: getIndex(3, 17), },
            { key: KeyDefineEnum.SHIFT_L, index: getIndex(4, 0), },
            { key: KeyDefineEnum.KEY_CODE45, index: getIndex(4, 1), },
            { key: KeyDefineEnum.KEY_Z, index: getIndex(4, 2), },
            { key: KeyDefineEnum.KEY_X, index: getIndex(4, 3), }, 
            { key: KeyDefineEnum.KEY_C, index: getIndex(4, 4), },
            { key: KeyDefineEnum.KEY_V, index: getIndex(4, 5), },
            { key: KeyDefineEnum.KEY_B, index: getIndex(4, 6), },
            { key: KeyDefineEnum.KEY_N, index: getIndex(4, 7), },
            { key: KeyDefineEnum.KEY_M, index: getIndex(4, 8), },
            { key: KeyDefineEnum.KEY_COMMA, index: getIndex(4, 9), },
            { key: KeyDefineEnum.KEY_PERIOD, index: getIndex(4, 10), },
            { key: KeyDefineEnum.KEY_Interrogation, index: getIndex(4, 11), },
            { key: KeyDefineEnum.SHIFT_R, index: getIndex(4, 13), },
            { key: KeyDefineEnum.KEY_UpArrow, index: getIndex(4, 14), },
            { key: KeyDefineEnum.KEY_NUM_1, index: getIndex(4, 15), },
            { key: KeyDefineEnum.KEY_NUM_2, index: getIndex(4, 16), },
            { key: KeyDefineEnum.KEY_NUM_3, index: getIndex(4, 17), },
            { key: KeyDefineEnum.KEY_NUM_ENTER, index: getIndex(4, 18), },
            ...
            { key: KeyDefineEnum.KEY_LeftArrow, index: getIndex(5, 13), },
            { key: KeyDefineEnum.KEY_DownArrow, index: getIndex(5, 14), },
            { key: KeyDefineEnum.KEY_RightArrow, index: getIndex(5, 15), },
            { key: KeyDefineEnum.KEY_NUM_0, index: getIndex(5, 16), },
            { key: KeyDefineEnum.KEY_NUM_DOT, index: getIndex(5, 17), },
        ],
        keyColors: [
            '#FFFFFF',
            '#FFFFFF',
    ...
    const init = async () => {
        ...
        if (rk_f99.value != undefined && !isInited.value) {
            rk_f99.value.addEventListener(RK_F99_EVENT_DEFINE.OnProfileGotten, profileGotten, false);
            rk_f99.value.addEventListener(RK_F99_EVENT_DEFINE.OnLedEffectGotten, ledEffectGotten, false);
            rk_f99.value.addEventListener(RK_F99_EVENT_DEFINE.OnLedColorsGotten, ledColorsGotten, false);
            boardProfile.value = rk_f99.value.data.boardProfile
            ledEffect.value = rk_f99.value.data.ledEffect
            ledColors.value = rk_f99.value.data.ledColors
            isInited.value = true;
        }
    ...
    const destroy = () => {
        if (rk_f99.value != undefined) {
            rk_f99.value.removeEventListener(RK_F99_EVENT_DEFINE.OnProfileGotten, profileGotten, false);
            rk_f99.value.removeEventListener(RK_F99_EVENT_DEFINE.OnLedEffectGotten, ledEffectGotten, false);
            rk_f99.value.removeEventListener(RK_F99_EVENT_DEFINE.OnLedColorsGotten, ledColorsGotten, false);
        }
    ...
    const DebounceChanged = (mode: number) => {
        state.debounce = mode;
        if (boardProfile.value != undefined && rk_f99.value != undefined) {
            boardProfile.value.setFieldValue(FieldEnum.Debounce, mode);
            rk_f99.value.setProfile(profileIndex.value);
        }
    };
    ...
    const getLightData = async () => {
        await rk_f99.value?.getProfile(profileIndex.value);
    }
    ...
    const profileGotten = async (event: any) => {
        ...
        await rk_f99.value?.getLedEffect(profileIndex.value);
        setProfile()
    };

    const ledEffectGotten = async (event: any) => {
        ledEffect.value = event.detail as LedEffect;
        await rk_f99.value?.getLedColors(profileIndex.value);
        setledEffect()
    };
    ...
    const refresh = async () => {
        ...
        //     profile.value = rk_m87.value.data.profile
        //     ledEffect.value = rk_m87.value.data.ledEffect
        //     ledColors.value = rk_m87.value.data.ledColors
        // }
        ...
        if (state.lightProps.light == LightEffectEnum.SelfDefine) {
            if (ledColors.value != undefined) {
                await rk_f99.value?.setLedColors(profileIndex.value);
            }
            // } else if (state.lightProps.light != LightEffectEnum.OFF && state.lightProps.light != LightEffectEnum.Music) {
            //     if (ledEffect.value != undefined) {
            //         await rk_m87.value?.setLedEffect(profileIndex.value);
            //     }
        }
    ...
    const ligtChanged = async () => {
        if (boardProfile.value != undefined && rk_f99.value != undefined) {
            ...
            await rk_f99.value.setProfile(profileIndex.value);
            await refresh();
        }
    };
    ...
    const onPicked = async () => {
        ...
        //     if (state.lightProps.light == LightEffectEnum.SelfDefine) {
        //         if (ledColors.value != undefined) {
        //             await rk_m87.value.setLedColors(profileIndex.value);
        //         }
        //     } else if (state.lightProps.light != LightEffectEnum.OFF && state.lightProps.light != LightEffectEnum.Music) {
        //         if (ledEffect.value != undefined) {
        //             await rk_m87.value.setLedEffect(profileIndex.value);
        ...
        if (state.lightProps.light != LightEffectEnum.OFF && state.lightProps.light != LightEffectEnum.Music) {
            if (ledEffect.value != undefined) {
                await rk_f99.value?.setLedEffect(profileIndex.value);
            }
        }
        //}
    };
