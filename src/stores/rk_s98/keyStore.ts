...
import { KeyCodeEnum, KeyDefineEnum, KeyText, KeyText_Mac } from '@/common/keyCode_s98'
...
import { KeyMatrix } from '@/keyboard/beiying/rk_s98/keyMatrix';
import { Action, Macro, Macros } from '@/keyboard/beiying/rk_s98/macros';
import { Profile, ps } from '@/keyboard/beiying/rk_s98/profiles';
import { KeyCodeMap } from '@/common/keyCode_s98'
import fileSaver from "file-saver";
import { ElMessage } from 'element-plus'

import { storage } from '@/common/storage';
import { BoardProfile, FieldEnum, PROFILE_DEFAULT_DATA } from '@/keyboard/beiying/rk_s98/boardProfile';
import { LedEffect } from '@/keyboard/beiying/rk_s98/ledEffect';
import { LedColors } from '@/keyboard/beiying/rk_s98/ledColors';
import { useI18n } from 'vue-i18n';

export const useKeyStore = defineStore('keyinfo_rk_s98', () => {
  ...
  const keyMatrix_us = [
    {
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_DEL, style: 'key space-l', index: getIndex(0, 14), keyData: getKeyData(getIndex(0, 14)) },
      ]
    },
    {
      line: 2,
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_HOME, style: 'key space-l', index: getIndex(1, 14), keyData: getKeyData(getIndex(1, 14)) },
    ...
    },
    {
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_PGUP, style: 'key space-l', index: getIndex(2, 14), keyData: getKeyData(getIndex(2, 14)) },
    ...
    },
    {
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_PGDN, style: 'key space-l', index: getIndex(3, 14), keyData: getKeyData(getIndex(3, 14)) },
    ...
    },
    {
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_NUM_1, style: 'key space-l3', index: getIndex(4, 15), keyData: getKeyData(getIndex(4, 15)) },
  ...
  const keyMatrix_es = [
    ...
    },
    {
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_PGUP, style: 'key key-right1', index: getIndex(2, 14), keyData: getKeyData(getIndex(2, 14)) },
        { key: KeyDefineEnum.KEY_NUM_7, style: 'key key-right2', index: getIndex(2, 15), keyData: getKeyData(getIndex(2, 15)) },
        { key: KeyDefineEnum.KEY_NUM_8, style: 'key key-right3', index: getIndex(2, 16), keyData: getKeyData(getIndex(2, 16)) },
        { key: KeyDefineEnum.KEY_NUM_9, style: 'key key-right4', index: getIndex(2, 17), keyData: getKeyData(getIndex(2, 17)) },
        { key: KeyDefineEnum.KEY_NUM_PLUS, style: 'key key10 key-right5', index: getIndex(2, 18), keyData: getKeyData(getIndex(2, 18)) },
      ]
    },
    {
      line: 4,
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_PGDN, style: 'key key-right1', index: getIndex(3, 14), keyData: getKeyData(getIndex(3, 14)) },
        { key: KeyDefineEnum.KEY_NUM_4, style: 'key key-right2', index: getIndex(3, 15), keyData: getKeyData(getIndex(3, 15)) },
        { key: KeyDefineEnum.KEY_NUM_5, style: 'key key-right3', index: getIndex(3, 16), keyData: getKeyData(getIndex(3, 16)) },
        { key: KeyDefineEnum.KEY_NUM_6, style: 'key key-right4', index: getIndex(3, 17), keyData: getKeyData(getIndex(3, 17)) },
      ]
    },
    {
      line: 5,
  ...
  const keyMatrix_jp = [
    ...
    },
    {
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_Underscore, style: 'key', index: getIndex(1, 11), keyData: getKeyData(getIndex(1, 11)) },
        { key: KeyDefineEnum.KEY_EqualSign, style: 'key', index: getIndex(1, 12), keyData: getKeyData(getIndex(1, 12)) },
        { key: KeyDefineEnum.KEY_CODE14, style: 'key', index: getIndex(0, 17), keyData: getKeyData(getIndex(0, 17)) },
        { key: KeyDefineEnum.KEY_Backspace, style: 'key', index: getIndex(1, 13), keyData: getKeyData(getIndex(1, 13)) },
        { key: KeyDefineEnum.KEY_HOME, style: 'key space-l', index: getIndex(1, 14), keyData: getKeyData(getIndex(1, 14)) },
        { key: KeyDefineEnum.KEY_NUMLOCK, style: 'key space-l', index: getIndex(1, 15), keyData: getKeyData(getIndex(1, 15)) },
        { key: KeyDefineEnum.KEY_NUM_DIV, style: 'key', index: getIndex(1, 16), keyData: getKeyData(getIndex(1, 16)) },
        { key: KeyDefineEnum.KEY_NUM_MUL, style: 'key', index: getIndex(1, 17), keyData: getKeyData(getIndex(1, 17)) },
    ...
    },
    {
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_CODE131, style: 'key key_jp', index: getIndex(5, 3), keyData: getKeyData(getIndex(5, 3)) },
        ...
        { key: KeyDefineEnum.ALT_R, style: 'key', index: getIndex(5, 8), keyData: getKeyData(getIndex(5, 8)) },
        { key: KeyDefineEnum.KEY_Fn1, style: 'key', index: getIndex(5, 9), keyData: getKeyData(getIndex(5, 9)) },
        { key: KeyDefineEnum.CTRL_R, style: 'key', index: getIndex(5, 10), keyData: getKeyData(getIndex(5, 10)) },
  ...
  const collapsedFunKeys: Record<string, Array<KeyDefineEnum>> = {
    "RK-S98": [KeyDefineEnum.KEY_CODE131, KeyDefineEnum.KEY_CODE132, KeyDefineEnum.KEY_CODE133, KeyDefineEnum.KEY_CODE14],
    "RK-S98 JP": [],
    "RK-S98 TH": [KeyDefineEnum.KEY_CODE131, KeyDefineEnum.KEY_CODE132, KeyDefineEnum.KEY_CODE133, KeyDefineEnum.KEY_CODE14],
    "RK-S98 RU": [KeyDefineEnum.KEY_CODE131, KeyDefineEnum.KEY_CODE132, KeyDefineEnum.KEY_CODE133, KeyDefineEnum.KEY_CODE14],
    "RK-S98 ES": [KeyDefineEnum.KEY_CODE131, KeyDefineEnum.KEY_CODE132, KeyDefineEnum.KEY_CODE133, KeyDefineEnum.KEY_CODE14],
  }
  ...
  const init = async () => {
    ...
    if (rk_s98.value == undefined) {
      ...
      //await rk_m87.value?.setKeyMatrix(layer, MatrixTable.WIN, 0);
      //await rk_m87.value?.setProfile(0);
      //await rk_m87.value?.setLedEffect(0);
      //await rk_m87.value?.setLedColors(0);
    }

    if (rk_s98.value != undefined && !isInited.value) {
      rk_s98.value.addEventListener(RK_S98_EVENT_DEFINE.OnKeyMatrixGotten, keyMatrixGotten, false);
  ...
  const destroy = () => {
    if (rk_s98.value != undefined) {
      rk_s98.value.removeEventListener(RK_S98_EVENT_DEFINE.OnKeyMatrixGotten, keyMatrixGotten, false);
    }
  ...
  const getProfiles = () => {
    if (rk_s98.value != undefined) {
      ...
      if (keyboard.keyboardDefine != undefined) {
        ...
        for (type in keyboard.keyboardDefine.keyMatrixTable) {
          ...
          for (index in keyboard.keyboardDefine.keyMatrixLayer) {
            ...
            if (!rk_s98.value.data.keyMatrixs.hasOwnProperty(table)) {
              rk_s98.value.data.keyMatrixs[table] = {};
            }
            rk_s98.value.data.keyMatrixs[table][layer] = new KeyMatrix(new DataView(new Uint8Array(Object.values(profile.value.get(table, layer))).buffer));
      ...
      if (profile.value.profile != undefined) {
        if (rk_s98.value.data.boardProfile != undefined) {
          rk_s98.value.data.boardProfile.buffer = new DataView(new Uint8Array(Object.values(profile.value.profile)).buffer);
        } else {
          rk_s98.value.data.boardProfile = new BoardProfile(new DataView(new Uint8Array(Object.values(profile.value.profile)).buffer));
        }
      }

      if (profile.value.ledEffect != undefined) {
        if (rk_s98.value.data.ledEffect != undefined) {
          rk_s98.value.data.ledEffect.buffer = new DataView(new Uint8Array(Object.values(profile.value.ledEffect)).buffer);
        } else {
          rk_s98.value.data.ledEffect = new LedEffect(new DataView(new Uint8Array(Object.values(profile.value.ledEffect)).buffer));
        }
      }

      if (profile.value.ledColors != undefined) {
        if (rk_s98.value.data.ledColors != undefined) {
          rk_s98.value.data.ledColors.buffer = new DataView(new Uint8Array(Object.values(profile.value.ledColors)).buffer);
        } else {
          rk_s98.value.data.ledColors = new LedColors(new DataView(new Uint8Array(Object.values(profile.value.ledColors)).buffer));
        }
      }

      KeyMatrixData.value = rk_s98.value.data.keyMatrixs;
    }
    refresh();
  }
  ...
  const clickProfile = async (obj: Profile) => {
    ...
    if (profile.value != undefined && keyboard.keyboardDefine != undefined) {
      ...
      for (type in keyboard.keyboardDefine.keyMatrixTable) {
        ...
        for (index in keyboard.keyboardDefine.keyMatrixLayer) {
          ...
          await rk_s98.value?.setKeyMatrix(layer, table, 0);
        }
      }
      // let table = MatrixTable.WIN;
      // for (index in keyboard.keyboardDefine.keyMatrixLayer) {
    ...
    if (profile.value?.profile != undefined && rk_s98.value != undefined && rk_s98.value.data.boardProfile != undefined) {
      rk_s98.value.data.boardProfile.buffer = new DataView(new Uint8Array(Object.values(profile.value.profile)).buffer);
    }
    if (profile.value?.ledEffect != undefined && rk_s98.value != undefined && rk_s98.value.data.ledEffect != undefined) {
      rk_s98.value.data.ledEffect.buffer = new DataView(new Uint8Array(Object.values(profile.value.ledEffect)).buffer);
    }
    if (profile.value?.ledColors != undefined && rk_s98.value != undefined && rk_s98.value.data.ledColors != null) {
      rk_s98.value.data.ledColors.buffer = new DataView(new Uint8Array(Object.values(profile.value?.ledColors)).buffer);
    }
  ...
  const saveProfile = () => {
    ...
    if (rk_s98.value?.data.boardProfile != undefined) {
      const dataView = new DataView(rk_s98.value?.data.boardProfile.buffer.buffer)
      profile.value?.setProfile(new Uint8Array(dataView.buffer, dataView.byteOffset, dataView.byteLength))
    }
    if (rk_s98.value?.data.ledEffect != undefined) {
      const dataView = new DataView(rk_s98.value?.data.ledEffect.buffer.buffer)
      profile.value?.setledEffect(new Uint8Array(dataView.buffer, dataView.byteOffset, dataView.byteLength))

    }
    if (rk_s98.value?.data.ledColors != undefined) {
      const dataView = new DataView(rk_s98.value?.data.ledColors.buffer.buffer)
  ...
  const setToFactory = async () => {
    if (rk_s98.value != undefined) {
      ...
      await rk_s98.value.setFactory();
      storage.clear();
      getProfiles();
      await rk_s98.value.setProfile(0);
      if (keyboard.keyboardDefine != undefined) {
        let index: any, type: any;
        for (type in keyboard.keyboardDefine.keyMatrixTable) {
          let table = keyboard.keyboardDefine.keyMatrixTable[type];
  ...
  const keySetStr = (keyData: KeyTableData) => {
    ...
    switch (mapping.keyMappingType) {
      case KeyMappingType.KeyBoard:
        ...
        // if (mapping.keyStr.length == 1) {
        //   mapping.keyStr = [t(mapping.keyStr[0].valueOf())];
        // }
        break;
  ...
  const keyClick = async(index: number) => {
    ...
    if (keyCode != undefined) {
      ...
      await rk_s98.value?.setKeyMatrix(keyMatrixLayer.value, keyMatrixTable.value, 0);
  ...
  const mapping = (keyCode: KeyDefineEnum, table: MatrixTable) => {
    ...
    if (key != undefined) {
      ...
      KeyMatrixData.value[keyMatrixTable.value][keyMatrixLayer.value]?.setKeyMapping(key.index, key.KeyData.keyMappingData);
      rk_s98.value?.setKeyMatrix(keyMatrixLayer.value, keyMatrixTable.value, 0);
      unSelected();
      setUnselected(keyCode);
    }
  ...
  const keySetMacro = (index: number) => {
    ...
    if (rk_s98.value != undefined && macros.value == undefined) {
      macros.value = rk_s98.value.data.macros;
    }
