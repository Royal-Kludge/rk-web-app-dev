...
import { RK_L98, RK_L98_EVENT_DEFINE } from '@/keyboard/rk_l98/rk_l98';
...
import { Action, Macro, Macros } from '@/keyboard/rk_l98/macros';
import { Profile, ps } from '@/keyboard/rk_l98/profiles';
import { KeyCodeMap } from '@/common/keyCode'
import fileSaver from "file-saver";
import { ElMessage } from 'element-plus'

import { storage } from '@/common/storage';
import { BoardProfile, FieldEnum, PROFILE_DEFAULT_DATA } from '@/keyboard/rk_l98/boardProfile';
import { LedEffect } from '@/keyboard/rk_l98/ledEffect';
import { LedColors } from '@/keyboard/rk_l98/ledColors';
  ...
  const keyMatrix_us = [
    {
      ...
      style: "space-t",
      keys: [
        { key: KeyDefineEnum.KEY_VolumI, style: 'key', index: getIndex(0, 0), keyData: getKeyData(getIndex(0, 0)) },
        { key: KeyDefineEnum.KEY_VolumD, style: 'key', index: getIndex(0, 1), keyData: getKeyData(getIndex(0, 1)) },
        { key: KeyDefineEnum.KEY_Mute, style: 'key', index: getIndex(0, 2), keyData: getKeyData(getIndex(0, 2)) },
        { key: KeyDefineEnum.KEY_Calculator, style: 'key', index: getIndex(0, 3), keyData: getKeyData(getIndex(0, 3)) },
        { key: KeyDefineEnum.KEY_ESC, style: 'key space-l', index: getIndex(0, 4), keyData: getKeyData(getIndex(0, 4)) },
        { key: KeyDefineEnum.KEY_F1, style: 'key space-l', index: getIndex(0, 6), keyData: getKeyData(getIndex(0, 6))},
        { key: KeyDefineEnum.KEY_F2, style: 'key', index: getIndex(0, 7), keyData: getKeyData(getIndex(0, 7)) },
        { key: KeyDefineEnum.KEY_F3, style: 'key', index: getIndex(0, 8), keyData: getKeyData(getIndex(0, 8)) },
        { key: KeyDefineEnum.KEY_F4, style: 'key', index: getIndex(0, 9), keyData: getKeyData(getIndex(0, 9)) },
        { key: KeyDefineEnum.KEY_F5, style: 'key space-l', index: getIndex(0, 10), keyData: getKeyData(getIndex(0, 10)) },
        { key: KeyDefineEnum.KEY_F6, style: 'key', index: getIndex(0, 11), keyData: getKeyData(getIndex(0, 11)) },
        { key: KeyDefineEnum.KEY_F7, style: 'key', index: getIndex(0, 12), keyData: getKeyData(getIndex(0, 12)) },
        { key: KeyDefineEnum.KEY_F8, style: 'key', index: getIndex(0, 13), keyData: getKeyData(getIndex(0, 13)) },
        { key: KeyDefineEnum.KEY_F9, style: 'key space-l', index: getIndex(0, 14), keyData: getKeyData(getIndex(0, 14)) },
        { key: KeyDefineEnum.KEY_F10, style: 'key', index: getIndex(0, 15), keyData: getKeyData(getIndex(0, 15)) },
        { key: KeyDefineEnum.KEY_F11, style: 'key', index: getIndex(0, 16), keyData: getKeyData(getIndex(0, 16)) },
        { key: KeyDefineEnum.KEY_F12, style: 'key', index: getIndex(0, 17), keyData: getKeyData(getIndex(0, 17)) },
        { key: KeyDefineEnum.KEY_DEL, style: 'key space-l', index: getIndex(0, 18), keyData: getKeyData(getIndex(0, 18)) },
        { key: KeyDefineEnum.KEY_Mute, style: 'key space-l', index: getIndex(0, 19), keyData: getKeyData(getIndex(0, 19)) },
      ]
    },
    {
      line: 2,
      style: "space-t",
      keys: [
        { key: KeyDefineEnum.KEY_NUMLOCK, style: 'key', index: getIndex(1, 0), keyData: getKeyData(getIndex(1, 0)) },
        { key: KeyDefineEnum.KEY_NUM_DIV, style: 'key', index: getIndex(1, 1), keyData: getKeyData(getIndex(1, 1)) },
        { key: KeyDefineEnum.KEY_NUM_MUL, style: 'key', index: getIndex(1, 2), keyData: getKeyData(getIndex(1, 2)) },
        { key: KeyDefineEnum.KEY_NUM_MINUS, style: 'key', index: getIndex(1, 3), keyData: getKeyData(getIndex(1, 3)) },
        { key: KeyDefineEnum.KEY_TILDE, style: 'key space-l', index: getIndex(1, 4), keyData: getKeyData(getIndex(1, 4)) },
        { key: KeyDefineEnum.KEY_1, style: 'key', index: getIndex(1, 5), keyData: getKeyData(getIndex(1, 5)) },
        { key: KeyDefineEnum.KEY_2, style: 'key', index: getIndex(1, 6), keyData: getKeyData(getIndex(1, 6)) },
        { key: KeyDefineEnum.KEY_3, style: 'key', index: getIndex(1, 7), keyData: getKeyData(getIndex(1, 7)) },
        { key: KeyDefineEnum.KEY_4, style: 'key', index: getIndex(1, 8), keyData: getKeyData(getIndex(1, 8)) },
        { key: KeyDefineEnum.KEY_5, style: 'key', index: getIndex(1, 9), keyData: getKeyData(getIndex(1, 9)) },
        { key: KeyDefineEnum.KEY_6, style: 'key', index: getIndex(1, 10), keyData: getKeyData(getIndex(1, 10)) },
        { key: KeyDefineEnum.KEY_7, style: 'key', index: getIndex(1, 11), keyData: getKeyData(getIndex(1, 11)) },
        { key: KeyDefineEnum.KEY_8, style: 'key', index: getIndex(1, 12), keyData: getKeyData(getIndex(1, 12)) },
        { key: KeyDefineEnum.KEY_9, style: 'key', index: getIndex(1, 13), keyData: getKeyData(getIndex(1, 13)) },
        { key: KeyDefineEnum.KEY_0, style: 'key', index: getIndex(1, 14), keyData: getKeyData(getIndex(1, 14)) },
        { key: KeyDefineEnum.KEY_Underscore, style: 'key', index: getIndex(1, 15), keyData: getKeyData(getIndex(1, 15)) },
        { key: KeyDefineEnum.KEY_EqualSign, style: 'key', index: getIndex(1, 16), keyData: getKeyData(getIndex(1, 16)) },
        { key: KeyDefineEnum.KEY_Backspace, style: 'key key2', index: getIndex(1, 17), keyData: getKeyData(getIndex(1, 17)) },
        { key: KeyDefineEnum.KEY_PGUP, style: 'key space-l', index: getIndex(1, 19), keyData: getKeyData(getIndex(1, 19)) },
      ]
    },
    {
      line: 3,
      style: "",
      keys: [
        { key: KeyDefineEnum.KEY_NUM_7, style: 'key', index: getIndex(2, 0), keyData: getKeyData(getIndex(2, 0)) },
        { key: KeyDefineEnum.KEY_NUM_8, style: 'key', index: getIndex(2, 1), keyData: getKeyData(getIndex(2, 1)) },
        { key: KeyDefineEnum.KEY_NUM_9, style: 'key', index: getIndex(2, 2), keyData: getKeyData(getIndex(2, 2)) },
        { key: KeyDefineEnum.KEY_NUM_PLUS, style: 'key key10', index: getIndex(2, 3), keyData: getKeyData(getIndex(2, 3)) },
        { key: KeyDefineEnum.KEY_TAB, style: 'key key3 space-l', index: getIndex(2, 4), keyData: getKeyData(getIndex(2, 4)) },
        { key: KeyDefineEnum.KEY_Q, style: 'key', index: getIndex(2, 5), keyData: getKeyData(getIndex(2, 5)) },
        { key: KeyDefineEnum.KEY_W, style: 'key', index: getIndex(2, 6), keyData: getKeyData(getIndex(2, 6)) },
        { key: KeyDefineEnum.KEY_E, style: 'key', index: getIndex(2, 7), keyData: getKeyData(getIndex(2, 7)) },
        { key: KeyDefineEnum.KEY_R, style: 'key', index: getIndex(2, 8), keyData: getKeyData(getIndex(2, 8)) },
        { key: KeyDefineEnum.KEY_T, style: 'key', index: getIndex(2, 9), keyData: getKeyData(getIndex(2, 9)) },
        { key: KeyDefineEnum.KEY_Y, style: 'key', index: getIndex(2, 10), keyData: getKeyData(getIndex(2, 10)) },
        { key: KeyDefineEnum.KEY_U, style: 'key', index: getIndex(2, 11), keyData: getKeyData(getIndex(2, 11)) },
        { key: KeyDefineEnum.KEY_I, style: 'key', index: getIndex(2, 12), keyData: getKeyData(getIndex(2, 12)) },
        { key: KeyDefineEnum.KEY_O, style: 'key', index: getIndex(2, 13), keyData: getKeyData(getIndex(2, 13)) },
        { key: KeyDefineEnum.KEY_P, style: 'key', index: getIndex(2, 14), keyData: getKeyData(getIndex(2, 14)) },
        { key: KeyDefineEnum.KEY_L_Brackets, style: 'key', index: getIndex(2, 15), keyData: getKeyData(getIndex(2, 15)) },
        { key: KeyDefineEnum.KEY_R_Brackets, style: 'key', index: getIndex(2, 16), keyData: getKeyData(getIndex(2, 16)) },
        { key: KeyDefineEnum.KEY_CODE29, style: 'key key3', index: getIndex(2, 17), keyData: getKeyData(getIndex(2, 17)) },
        { key: KeyDefineEnum.KEY_PGDN, style: 'key space-l', index: getIndex(2, 19), keyData: getKeyData(getIndex(2, 19)) }
      ]
    },
    {
      line: 4,
      style: "",
      keys: [
        { key: KeyDefineEnum.KEY_NUM_4, style: 'key', index: getIndex(3, 0), keyData: getKeyData(getIndex(3, 0)) },
        { key: KeyDefineEnum.KEY_NUM_5, style: 'key', index: getIndex(3, 1), keyData: getKeyData(getIndex(3, 1)) },
        { key: KeyDefineEnum.KEY_NUM_6, style: 'key', index: getIndex(3, 2), keyData: getKeyData(getIndex(3, 2)) },
        { key: KeyDefineEnum.KEY_CAPSLOCK, style: 'key key2 space-l3', index: getIndex(3, 4), keyData: getKeyData(getIndex(3, 4)) },
        { key: KeyDefineEnum.KEY_A, style: 'key', index: getIndex(3, 5), keyData: getKeyData(getIndex(3, 5)) },
        { key: KeyDefineEnum.KEY_S, style: 'key', index: getIndex(3, 6), keyData: getKeyData(getIndex(3, 6)) },
        { key: KeyDefineEnum.KEY_D, style: 'key', index: getIndex(3, 7), keyData: getKeyData(getIndex(3, 7)) },
        { key: KeyDefineEnum.KEY_F, style: 'key', index: getIndex(3, 8), keyData: getKeyData(getIndex(3, 8)) },
        { key: KeyDefineEnum.KEY_G, style: 'key', index: getIndex(3, 9), keyData: getKeyData(getIndex(3, 9)) },
        { key: KeyDefineEnum.KEY_H, style: 'key', index: getIndex(3, 10), keyData: getKeyData(getIndex(3, 10)) },
        { key: KeyDefineEnum.KEY_J, style: 'key', index: getIndex(3, 11), keyData: getKeyData(getIndex(3, 11)) },
        { key: KeyDefineEnum.KEY_K, style: 'key', index: getIndex(3, 12), keyData: getKeyData(getIndex(3, 12)) },
        { key: KeyDefineEnum.KEY_L, style: 'key', index: getIndex(3, 13), keyData: getKeyData(getIndex(3, 13)) },
        { key: KeyDefineEnum.KEY_Semicolon, style: 'key', index: getIndex(3, 14), keyData: getKeyData(getIndex(3, 14)) },
        { key: KeyDefineEnum.KEY_Quotation, style: 'key', index: getIndex(3, 15), keyData: getKeyData(getIndex(3, 15)) },
        { key: KeyDefineEnum.KEY_ENTER, style: 'key key2', index: getIndex(3, 17), keyData: getKeyData(getIndex(3, 17)) },
      ]
    },
    {
      line: 5,
      style: "p-r",
      keys: [
        { key: KeyDefineEnum.KEY_NUM_1, style: 'key', index: getIndex(4, 0), keyData: getKeyData(getIndex(4, 0)) },
        { key: KeyDefineEnum.KEY_NUM_2, style: 'key', index: getIndex(4, 1), keyData: getKeyData(getIndex(4, 1)) },
        { key: KeyDefineEnum.KEY_NUM_3, style: 'key', index: getIndex(4, 2), keyData: getKeyData(getIndex(4, 2)) },
        { key: KeyDefineEnum.SHIFT_L, style: 'key key4 space-l3', index: getIndex(4, 4), keyData: getKeyData(getIndex(4, 4)) },
        { key: KeyDefineEnum.KEY_Z, style: 'key', index: getIndex(4, 5), keyData: getKeyData(getIndex(4, 5)) },
        { key: KeyDefineEnum.KEY_X, style: 'key', index: getIndex(4, 6), keyData: getKeyData(getIndex(4, 6)) },
        { key: KeyDefineEnum.KEY_C, style: 'key', index: getIndex(4, 7), keyData: getKeyData(getIndex(4, 7)) },
        { key: KeyDefineEnum.KEY_V, style: 'key', index: getIndex(4, 8), keyData: getKeyData(getIndex(4, 8)) },
        { key: KeyDefineEnum.KEY_B, style: 'key', index: getIndex(4, 9), keyData: getKeyData(getIndex(4, 9)) },
        { key: KeyDefineEnum.KEY_N, style: 'key', index: getIndex(4, 10), keyData: getKeyData(getIndex(4, 10)) },
        { key: KeyDefineEnum.KEY_M, style: 'key', index: getIndex(4, 11), keyData: getKeyData(getIndex(4, 11)) },
        { key: KeyDefineEnum.KEY_COMMA, style: 'key', index: getIndex(4, 12), keyData: getKeyData(getIndex(4, 12)) },
        { key: KeyDefineEnum.KEY_PERIOD, style: 'key', index: getIndex(4, 13), keyData: getKeyData(getIndex(4, 13)) },
        { key: KeyDefineEnum.KEY_Interrogation, style: 'key', index: getIndex(4, 14), keyData: getKeyData(getIndex(4, 14)) },
        { key: KeyDefineEnum.SHIFT_R, style: 'key key3', index: getIndex(4, 17), keyData: getKeyData(getIndex(4, 17)) },
        { key: KeyDefineEnum.KEY_UpArrow, style: 'key key-up', index: getIndex(4, 18), keyData: getKeyData(getIndex(4, 18)) },
      ]
    },
    {
      line: 6,
      style: "p-r", 
      keys: [
        { key: KeyDefineEnum.KEY_NUM_0, style: 'key key8', index: getIndex(5, 0), keyData: getKeyData(getIndex(5, 0)) },
        { key: KeyDefineEnum.KEY_NUM_DOT, style: 'key', index: getIndex(5, 1), keyData: getKeyData(getIndex(5, 1)) },
        { key: KeyDefineEnum.KEY_NUM_ENTER, style: 'key key9', index: getIndex(5, 3), keyData: getKeyData(getIndex(5, 3))},
        { key: KeyDefineEnum.CTRL_L, style: 'key key6 space-l', index: getIndex(5, 4), keyData: getKeyData(getIndex(5, 4)) },
        { key: KeyDefineEnum.WIN_L, style: 'key key6', index: getIndex(5, 5), keyData: getKeyData(getIndex(5, 5)) },
        { key: KeyDefineEnum.ALT_L, style: 'key key6', index: getIndex(5, 6), keyData: getKeyData(getIndex(5, 6)) },
        { key: KeyDefineEnum.KEY_SPACEBAR, style: 'key key5', index: getIndex(5, 9), keyData: getKeyData(getIndex(5, 9)) },
        { key: KeyDefineEnum.ALT_R, style: 'key', index: getIndex(5, 12), keyData: getKeyData(getIndex(5, 12)) },
        { key: KeyDefineEnum.KEY_Fn1, style: 'key', index: getIndex(5, 13), keyData: getKeyData(getIndex(5, 13)) },
        { key: KeyDefineEnum.KEY_R_CTRL, style: 'key', index: getIndex(5, 14), keyData: getKeyData(getIndex(5, 14)) },
        { key: KeyDefineEnum.KEY_LeftArrow, style: 'key key-left', index: getIndex(5, 17), keyData: getKeyData(getIndex(5, 17)) },
        { key: KeyDefineEnum.KEY_DownArrow, style: 'key key-down', index: getIndex(5, 18), keyData: getKeyData(getIndex(5, 18)) },
        { key: KeyDefineEnum.KEY_RightArrow, style: 'key key-right', index: getIndex(5, 19), keyData: getKeyData(getIndex(5, 19)) }
      ]
    },
  ];
 ...
 /*const keyMatrix_uk = [
    {
      ...
      style: "space-t",
      keys: [
        { key: KeyDefineEnum.KEY_Stop, style: 'key key6 space-l4', index: getIndex(0, 5), keyData: getKeyData(getIndex(0, 5)) },
        { key: KeyDefineEnum.KEY_PrevTr, style: 'key key6', index: getIndex(0, 6), keyData: getKeyData(getIndex(0, 6)) },
        { key: KeyDefineEnum.KEY_PlayPause, style: 'key key6', index: getIndex(0, 7), keyData: getKeyData(getIndex(0, 7)) },
        { key: KeyDefineEnum.KEY_NextTr, style: 'key key6', index: getIndex(0, 8), keyData: getKeyData(getIndex(0, 8)) },
      ]
    },
    {
      line: 2,
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_ESC, style: 'key', index: getIndex(1, 1), keyData: getKeyData(getIndex(1, 1)) },
        ...
        { key: KeyDefineEnum.KEY_4, style: 'key', index: getIndex(1, 5), keyData: getKeyData(getIndex(1, 5)) },
        { key: KeyDefineEnum.KEY_5, style: 'key', index: getIndex(1, 6), keyData: getKeyData(getIndex(1, 6)) },
        { key: KeyDefineEnum.KEY_6, style: 'key', index: getIndex(1, 7), keyData: getKeyData(getIndex(1, 7)) },
        { key: KeyDefineEnum.KEY_7, style: 'key', index: getIndex(1, 8), keyData: getKeyData(getIndex(1, 8)) },
        { key: KeyDefineEnum.KEY_8, style: 'key', index: getIndex(1, 9), keyData: getKeyData(getIndex(1, 9)) },
        { key: KeyDefineEnum.KEY_9, style: 'key', index: getIndex(1, 10), keyData: getKeyData(getIndex(1, 10)) },
        { key: KeyDefineEnum.KEY_0, style: 'key', index: getIndex(1, 11), keyData: getKeyData(getIndex(1, 11)) },
        { key: KeyDefineEnum.KEY_Underscore, style: 'key', index: getIndex(1, 12), keyData: getKeyData(getIndex(1, 12)) },
        { key: KeyDefineEnum.KEY_EqualSign, style: 'key', index: getIndex(1, 13), keyData: getKeyData(getIndex(1, 13)) },
        { key: KeyDefineEnum.KEY_Backspace, style: 'key key2', index: getIndex(1, 14), keyData: getKeyData(getIndex(1, 14)) },
        { key: KeyDefineEnum.KEY_HOME, style: 'key', index: getIndex(1, 16), keyData: getKeyData(getIndex(1, 16)) },
      ]
    },
    {
      line: 3,
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_R, style: 'key', index: getIndex(2, 5), keyData: getKeyData(getIndex(2, 5)) },
        { key: KeyDefineEnum.KEY_T, style: 'key', index: getIndex(2, 6), keyData: getKeyData(getIndex(2, 6)) },
        { key: KeyDefineEnum.KEY_Y, style: 'key', index: getIndex(2, 7), keyData: getKeyData(getIndex(2, 7)) },
        { key: KeyDefineEnum.KEY_U, style: 'key', index: getIndex(2, 8), keyData: getKeyData(getIndex(2, 8)) },
        { key: KeyDefineEnum.KEY_I, style: 'key', index: getIndex(2, 9), keyData: getKeyData(getIndex(2, 9)) },
        { key: KeyDefineEnum.KEY_O, style: 'key', index: getIndex(2, 10), keyData: getKeyData(getIndex(2, 10)) },
        ...
        { key: KeyDefineEnum.KEY_ENTER, style: 'key key3 key_enter p-a', index: getIndex(2, 14), keyData: getKeyData(getIndex(2, 14)), img: '<br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ENTER' },
        { key: KeyDefineEnum.KEY_DEL, style: 'key', index: getIndex(2, 16), keyData: getKeyData(getIndex(2, 16)) }
      ]
    },
    {
      line: 4,
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_F, style: 'key', index: getIndex(3, 5), keyData: getKeyData(getIndex(3, 5)) },
        { key: KeyDefineEnum.KEY_G, style: 'key', index: getIndex(3, 6), keyData: getKeyData(getIndex(3, 6)) },
        { key: KeyDefineEnum.KEY_H, style: 'key', index: getIndex(3, 7), keyData: getKeyData(getIndex(3, 7)) },
        { key: KeyDefineEnum.KEY_J, style: 'key', index: getIndex(3, 8), keyData: getKeyData(getIndex(3, 8)) },
        { key: KeyDefineEnum.KEY_K, style: 'key', index: getIndex(3, 9), keyData: getKeyData(getIndex(3, 9)) },
        ...
        { key: KeyDefineEnum.KEY_CODE29, style: 'key', index: getIndex(3, 13), keyData: getKeyData(getIndex(3, 13)) },
        { key: KeyDefineEnum.KEY_PGUP, style: 'key space-l6', index: getIndex(3, 16), keyData: getKeyData(getIndex(3, 16)) },
      ]
    },
    {
      line: 5,
      ...
      keys: [
        ...
        { key: KeyDefineEnum.SHIFT_L, style: 'key key3', index: getIndex(4, 1), keyData: getKeyData(getIndex(4, 1)) },
        { key: KeyDefineEnum.KEY_CODE45, style: 'key', index: getIndex(4, 2), keyData: getKeyData(getIndex(4, 2)) },
        ...
        { key: KeyDefineEnum.KEY_V, style: 'key', index: getIndex(4, 6), keyData: getKeyData(getIndex(4, 6)) },
        { key: KeyDefineEnum.KEY_B, style: 'key', index: getIndex(4, 7), keyData: getKeyData(getIndex(4, 7)) },
        { key: KeyDefineEnum.KEY_N, style: 'key', index: getIndex(4, 8), keyData: getKeyData(getIndex(4, 8)) },
        { key: KeyDefineEnum.KEY_M, style: 'key', index: getIndex(4, 9), keyData: getKeyData(getIndex(4, 9)) },
        ...
        { key: KeyDefineEnum.KEY_UpArrow, style: 'key', index: getIndex(4, 15), keyData: getKeyData(getIndex(4, 15)) },
        { key: KeyDefineEnum.KEY_PGDN, style: 'key', index: getIndex(4, 16), keyData: getKeyData(getIndex(4, 16)) },
      ]
    },
    {
      line: 6,
      ...
      keys: [
        ...
        { key: KeyDefineEnum.KEY_SPACEBAR, style: 'key key8', index: getIndex(5, 6), keyData: getKeyData(getIndex(5, 6)) },
        { key: KeyDefineEnum.KEY_SPACEBAR, style: 'key key8', index: getIndex(5, 8), keyData: getKeyData(getIndex(5, 8)) },
        { key: KeyDefineEnum.ALT_R, style: 'key key9', index: getIndex(5, 9), keyData: getKeyData(getIndex(5, 9)) },
        { key: KeyDefineEnum.KEY_Fn1, style: 'key key9', index: getIndex(5, 10), keyData: getKeyData(getIndex(5, 10)) },
        { key: KeyDefineEnum.KEY_LeftArrow, style: 'key space-l5', index: getIndex(5, 14), keyData: getKeyData(getIndex(5, 14)) },
  ...
  const init = async () => {
    ...
    if (rk_l98.value == undefined) {
      ...
      //await rk_l98.value?.setKeyMatrix(layer, MatrixTable.WIN, 0);
      //await rk_l98.value?.setProfile(0);
      //await rk_l98.value?.setLedEffect(0);
      //await rk_l98.value?.setLedColors(0);
    }

    if (rk_l98.value != undefined && !isInited.value) {
      rk_l98.value.addEventListener(RK_L98_EVENT_DEFINE.OnKeyMatrixGotten, keyMatrixGotten, false);
      macros.value = rk_l98.value.data.macros;
      isInited.value = true;
    }
  };
  ...
  const destroy = () => {
    if (rk_l98.value != undefined) {
      rk_l98.value.removeEventListener(RK_L98_EVENT_DEFINE.OnKeyMatrixGotten, keyMatrixGotten, false);
    }
      ...
      if (keyboard.keyboardDefine != undefined) {
        ...
        for (type in keyboard.keyboardDefine.keyMatrixTable) {
          ...
          for (index in keyboard.keyboardDefine.keyMatrixLayer) {
            ...
            if (!rk_l98.value.data.keyMatrixs.hasOwnProperty(table)) {
              rk_l98.value.data.keyMatrixs[table] = {};
            }
            rk_l98.value.data.keyMatrixs[table][layer] = new KeyMatrix(new DataView(new Uint8Array(Object.values(profile.value.get(table, layer))).buffer));
            //rk_l98.value.data.keyMatrixs[table][layer] = new KeyMatrix(new DataView(profile.value.get(table, layer).buffer));
          }
        }
      }

      if (profile.value.profile != undefined) {
        if (rk_l98.value.data.boardProfile != undefined) {
          rk_l98.value.data.boardProfile.buffer = new DataView(new Uint8Array(Object.values(profile.value.profile)).buffer);
        } else {
          rk_l98.value.data.boardProfile = new BoardProfile(new DataView(new Uint8Array(Object.values(profile.value.profile)).buffer));
        }
      }

      if (profile.value.ledEffect != undefined) {
        if (rk_l98.value.data.ledEffect != undefined) {
          rk_l98.value.data.ledEffect.buffer = new DataView(new Uint8Array(Object.values(profile.value.ledEffect)).buffer);
        } else {
          rk_l98.value.data.ledEffect = new LedEffect(new DataView(new Uint8Array(Object.values(profile.value.ledEffect)).buffer));
        }
      }

      if (profile.value.ledColors != undefined) {
        if (rk_l98.value.data.ledColors != undefined) {
          rk_l98.value.data.ledColors.buffer = new DataView(new Uint8Array(Object.values(profile.value.ledColors)).buffer);
        } else {
          rk_l98.value.data.ledColors = new LedColors(new DataView(new Uint8Array(Object.values(profile.value.ledColors)).buffer));
        }
      }

      KeyMatrixData.value = rk_l98.value.data.keyMatrixs;
    }
    refresh();
  }
    ...
    if (profile.value != undefined && keyboard.keyboardDefine != undefined) {
      ...
      for (type in keyboard.keyboardDefine.keyMatrixTable) {
        ...
        for (index in keyboard.keyboardDefine.keyMatrixLayer) {
          ...
          await rk_l98.value?.setKeyMatrix(layer, table, 0);
        }
      }
      refresh()
    }

    if (profile.value?.profile != undefined && rk_l98.value != undefined && rk_l98.value.data.boardProfile != undefined) {
      rk_l98.value.data.boardProfile.buffer = new DataView(new Uint8Array(Object.values(profile.value.profile)).buffer);
    }
    if (profile.value?.ledEffect != undefined && rk_l98.value != undefined && rk_l98.value.data.ledEffect != undefined) {
      rk_l98.value.data.ledEffect.buffer = new DataView(new Uint8Array(Object.values(profile.value.ledEffect)).buffer);
    }
    if (profile.value?.ledColors != undefined && rk_l98.value != undefined && rk_l98.value.data.ledColors != null) {
      rk_l98.value.data.ledColors.buffer = new DataView(new Uint8Array(Object.values(profile.value?.ledColors)).buffer);
    }
  ...
  const saveProfile = () => {
    ...
    if (rk_l98.value?.data.boardProfile != undefined) {
      const dataView = new DataView(rk_l98.value?.data.boardProfile.buffer.buffer)
      profile.value?.setProfile(new Uint8Array(dataView.buffer, dataView.byteOffset, dataView.byteLength))
    }
    if (rk_l98.value?.data.ledEffect != undefined) {
      const dataView = new DataView(rk_l98.value?.data.ledEffect.buffer.buffer)
      profile.value?.setledEffect(new Uint8Array(dataView.buffer, dataView.byteOffset, dataView.byteLength))

    }
    if (rk_l98.value?.data.ledColors != undefined) {
      const dataView = new DataView(rk_l98.value?.data.ledColors.buffer.buffer) 
  ...
  const newProfile = () => {
    ...
    // if (rk_l98.value != undefined && rk_l98.value.data.boardProfile != undefined) {
    //   tm.profile = new Uint8Array(PROFILE_DEFAULT_DATA.buffer, 0, PROFILE_DEFAULT_DATA.buffer.byteLength);
    // }

    // if (rk_l98.value != undefined && rk_l98.value.data.ledEffect != undefined) {
    //   tm.ledEffect = new Uint8Array(rk_l98.value.data.ledEffect.buffer.buffer, 0, rk_l98.value.data.ledEffect.buffer.byteLength);
    // }
  ...
  const keySetMacro = (index: number) => {
    ...
    if (rk_l98.value != undefined && macros.value == undefined) {
      macros.value = rk_l98.value.data.macros;
    }
